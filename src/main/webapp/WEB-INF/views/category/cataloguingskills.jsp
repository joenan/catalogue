    ...
    <body>
        ...
        <main role="main">
            ...
            <div id="form-pager">
                ...
                <form class="pure-form steps" id="quiz_form" method="post" action="${pageContext.request.contextPath}/cataloguingskills">
                    <section id="page" class="step">
                        ...
                        <span>
                            ...
                            <div>
                                ...
                                <label for="question-2-answers-B">B) AACR2</label>
                            </div>
                    ...
                    <section id="page" class="step">
                        ...
                        <span>
                            ...
                            <div>
                                ...
                                <label for="question-4-answers-A">A) Chapter 21</label>
                            </div>
                    ...
                    <section id="page" class="step">
                        <span>
                            ...
                            <div>
13                                <label for="question-13-answers-B">B) False </label>
                            </div>
